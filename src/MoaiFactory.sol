...
contract MoaiFactory {
    ...
    event MoaiCreated(address indexed moaiAddress, address indexed creator, string name, uint256 contributionAmount);
    ...
    function createMoai(
        ...
        // Deploy new Moai
        Moai moai =
            new Moai(USDC, _name, _contributionAmount, _contributionDueDate, _removalThresholdMonths, _initialMember);
        ...
        emit MoaiCreated(moaiAddress, _initialMember, _name, _contributionAmount);
